...
\begin{history}
    ...
    \begin{wrapfigure}[4]{r}[0pt]{0.3\linewidth}
...
\groupphoto{0.93}{0.85}{./chap/2001-2024/2016/Montreux-2016.jpg}
...
\begin{history}
    ...
    \begin{MulticolFigure}
        ...
        \captionof{figure}{Marschmusik bei brütender Hitze}
    \end{MulticolFigure}
...
\begin{history}
    ...
    \begin{MulticolFigure}
        ...
        \captionof{figure}{Der Preis von 1000 Fr., gesponsert von der Luzerner Kantonalbank, wurde von
...
\begin{history}
    ...
    \begin{MulticolFigure}
        ...
        \captionof{figure}{wichtige Detailarbeit}
    \end{MulticolFigure}
    ...
    \begin{MulticolFigure}
        ...
        \captionof{figure}{Exakt ausgerichtet}
    \end{MulticolFigure}
...
\groupphoto{1.0}{1.0}{./chap/2001-2024/2024/MT-Wolhusen.jpg}
{\emph{Musiktag Wolhusen 2024}\\
    1. Reihe:\\
